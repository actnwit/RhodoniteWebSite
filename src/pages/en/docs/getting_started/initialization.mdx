...
| cacheWebGpuRenderBundles | Whether to cache render bundles in WebGPU |
...
| dataTextureHeight | The height of the data texture. The larger it is, the more data Rhodonite can handle. |
| dataTextureWidth | The width of the data texture. The larger it is, the more data Rhodonite can handle. |
